   ...
   <View style={{flex:1, backgroundColor:Color.black}}>
     <View style={{ backgroundColor:Color.black, alignItems:"center"}}>
      <View style={{width:"100%", height:"50%", marginTop:30}}>
        <Image source={Images.Onboarding3} resizeMode='contain' style={{width:"100%", height:"100%"}}/>
      </View>
      ...
      <View style={{ marginTop:"10%"}}>
        <Text style={{color:Color.white,fontSize:getFontSize(23), fontWeight:"bold", fontFamily:"Light",letterSpacing:1}}>Orgonaize your tasks</Text>
       
      </View>
      <View style={{ marginTop:"5%"}}>
      
        <Text style={{color:Color.white,fontSize:getFontSize(14),  fontFamily:"Thin", textAlign:"center", lineHeight:25, letterSpacing:0.7}}>You can organize your daily tasks by {'\n'} adding your tasks into separate categories</Text>
